...
Seven calls, in dependency order, with the ids the later ones need taken from the earlier responses:

| # | Call | Connector | Input from an earlier call |
| ---: | :--- | :--- | :--- |
| 1 | `uploadFileToUcm` | ERP integrations | — |
...
# fill in Config.toml first — see the sample README
bal run
```
